...
import { PlusCircle, Image as ImageIcon, Briefcase, MapPin, List, Clock, CheckCircle } from 'lucide-react';
...
export const PublishTab: React.FC<PublishTabProps> = ({ currentUser, onSuccess }) => {
  ...
  const handlePublish = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
        setToast('');
        setMode('dashboard'); // Go to dashboard instead of home to see the new request
    }, 1500);
  };
